        ...
        implements ConnectorPageSource
{
    ...
    {
        // we will use as many Presto page as columns are requested to leverage Presto's Parquet reader
        ...
        int outputIndex = 0;
        int delegateIndex = 0;
        // TODO: awkward loop based on stripped down code and retained as a reminder of potential logic
    ...
    private static Object deserializePartitionValue(Type type, String valueString, String name, TimeZoneKey timeZoneKey)
    {
        ...
        try {
            ...
            throw new PrestoException(DELTA_INVALID_PARTITION_VALUE, format(
