...
public class DeltaPartitioningProvider
        implements ConnectorNodePartitioningProvider
{
    private final NodeManager nodeManager;
    private final int splitsPerNode;

    public DeltaPartitioningProvider(NodeManager nodeManager, int splitsPerNode)
    {
    ...
    {
        // TODO: this constant (function) probably doesn't cut it
        return value -> 1;
    }
