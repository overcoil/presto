...
final class MetadataUtil
{
    ...
    public static final JsonCodec<DeltaColumnHandle> COLUMN_CODEC;
    public static final JsonCodec<DeltaTableHandle> TABLE_CODEC;
    ...
    static {
        ...
        COLUMN_CODEC = codecFactory.jsonCodec(DeltaColumnHandle.class);
        TABLE_CODEC = codecFactory.jsonCodec(DeltaTableHandle.class);
    }
