...
import static com.facebook.presto.deltalake.TableType.DATA;
import static com.facebook.presto.deltalake.TableType.FILES;
import static com.facebook.presto.deltalake.TableType.MANIFESTS;
import static com.facebook.presto.deltalake.TableType.PARTITIONS;
...
public class DeltaLakeTableName
{
    ...
    public DeltaLakeTableName(String tableName, TableType tableType, Optional<Long> snapshotId)
    {
    ...
    public static DeltaLakeTableName from(String name)
    {
        ...
        return new DeltaLakeTableName(table, type, version);
    }
}
