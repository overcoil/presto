...
import static com.facebook.presto.deltalake.DeltaLakeErrorCode.DELTALAKE_WRITER_OPEN_ERROR;
import static com.facebook.presto.deltalake.DeltaLakeSessionProperties.getCompressionCodec;
...
public class DeltaLakeFileWriterFactory
{
    ...
    public DeltaLakeFileWriter createFileWriter(
            Path outputPath,
    ...
    private DeltaLakeFileWriter createParquetWriter(
            Path outputPath,
            Schema icebergSchema,
            JobConf jobConf,
            ConnectorSession session,
            HdfsContext hdfsContext)
    {
        ...
        try {
            ...
            return new DeltaLakeParquetFileWriter(
            ...
            throw new PrestoException(DELTALAKE_WRITER_OPEN_ERROR, "Error creating Parquet file", e);
        }
    }
}
