        ...
        implements ConnectorSplitManager
{
    ...
    {
        DeltaLakeTableLayoutHandle layoutHandle = (DeltaLakeTableLayoutHandle) layout;
        DeltaLakeTableHandle table = layoutHandle.getTable();
        ...
        Table icebergTable = getDeltaLakeTable(metastore, hdfsEnvironment, session, table.getSchemaTableName());
        ...
        DeltaLakeSplitSource splitSource = new DeltaLakeSplitSource(tableScan.planTasks());
        return splitSource;
    }
}
