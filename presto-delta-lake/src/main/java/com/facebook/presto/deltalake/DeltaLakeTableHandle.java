        ...
        implements ConnectorTableHandle
{
    ...
    private final TupleDomain<DeltaLakeColumnHandle> predicate;
    ...
    public DeltaLakeTableHandle(
            ...
            @JsonProperty("predicate") TupleDomain<DeltaLakeColumnHandle> predicate)
    {
    ...
    @JsonProperty
    public TupleDomain<DeltaLakeColumnHandle> getPredicate()
    {
        return predicate;
    }
