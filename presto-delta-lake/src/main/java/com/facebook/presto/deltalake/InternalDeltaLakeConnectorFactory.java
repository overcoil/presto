...
public final class InternalDeltaLakeConnectorFactory
{
    ...
    public static Connector createConnector(String catalogName, Map<String, String> config, ConnectorContext context, Optional<ExtendedHiveMetastore> metastore)
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            ...
            DeltaLakeMetadataFactory metadataFactory = injector.getInstance(DeltaLakeMetadataFactory.class);
            ConnectorSplitManager splitManager = injector.getInstance(ConnectorSplitManager.class);
            ConnectorPageSourceProvider connectorPageSource = injector.getInstance(ConnectorPageSourceProvider.class);
//            ConnectorPageSinkProvider pageSinkProvider = injector.getInstance(ConnectorPageSinkProvider.class);
            ConnectorNodePartitioningProvider connectorDistributionProvider = injector.getInstance(ConnectorNodePartitioningProvider.class);
            DeltaLakeSessionProperties icebergSessionProperties = injector.getInstance(DeltaLakeSessionProperties.class);
            DeltaLakeTableProperties icebergTableProperties = injector.getInstance(DeltaLakeTableProperties.class);
